...
func (collector *Metrics) Collect(ch chan<- prometheus.Metric) {
	...
	for _, issue := range collectedIssues.Issues {
		...
		ch <- prometheus.MustNewConstMetric(collector.issue, prometheus.CounterValue, createdTimestamp, issue.Fields.Status.Name, issue.Fields.Project.Name, issue.Key, issue.Fields.Assignee.DisplayName, issue.Fields.Summary, issue.Fields.Issuetype.Name, issue.Fields.Priority.Name, issue.Fields.Progress.Progress, issue.Fields.Progress.Total, issue.Fields.Progress.Percent)
	}
}
